...
;  @ /home/sumiya11/loops/writefunc.jl:36 within `my_assume`
define float @julia_my_assume_176(float %0) #0 {
top:
...
;  @ /home/sumiya11/loops/writefunc.jl:37 within `my_assume`
...
L3:                                               ; preds = %top
   %8 = call nonnull {}* @j_throw_complex_domainerror_178({}* inttoptr (i64 140250411604544 to {}*), float %0) #0
   call void @llvm.trap()
   unreachable
...
define nonnull {}* @jfptr_my_assume_177({}* %0, {}** %1, i32 %2) #1 {
top:
  ...
  %8 = call float @julia_my_assume_176(float %7) #0
...
declare {}* @j_throw_complex_domainerror_178({}*, float)
